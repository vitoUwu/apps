...
import * as $$$$$$$$$22 from "./actions/cart/updateCustomData.ts";
import * as $$$$$$$$$23 from "./actions/cart/updateGifts.ts";
import * as $$$$$$$$$24 from "./actions/cart/updateItemAttachment.ts";
import * as $$$$$$$$$25 from "./actions/cart/updateItemPrice.ts";
import * as $$$$$$$$$26 from "./actions/cart/updateItems.ts";
import * as $$$$$$$$$27 from "./actions/cart/updateProfile.ts";
import * as $$$$$$$$$28 from "./actions/cart/updateUser.ts";
import * as $$$$$$$$$29 from "./actions/credentials/validate.ts";
import * as $$$$$$$$$30 from "./actions/events/productView.ts";
import * as $$$$$$$$$31 from "./actions/events/recommendationClick.ts";
import * as $$$$$$$$$32 from "./actions/events/recommendationView.ts";
import * as $$$$$$$$$33 from "./actions/masterdata/createDocument.ts";
import * as $$$$$$$$$34 from "./actions/masterdata/updateDocument.ts";
import * as $$$$$$$$$35 from "./actions/masterdata/updatePartialDocument.ts";
import * as $$$$$$$$$36 from "./actions/newsletter/subscribe.ts";
import * as $$$$$$$$$37 from "./actions/newsletter/updateNewsletterOptIn.ts";
import * as $$$$$$$$$38 from "./actions/notifyme.ts";
import * as $$$$$$$$$39 from "./actions/orders/cancel.ts";
import * as $$$$$$$$$40 from "./actions/payment/deletePaymentToken.ts";
import * as $$$$$$$$$41 from "./actions/profile/updateProfile.ts";
import * as $$$$$$$$$42 from "./actions/recommendation/startSession.ts";
import * as $$$$$$$$$43 from "./actions/review/submit.ts";
import * as $$$$$$$$$44 from "./actions/session/createSession.ts";
import * as $$$$$$$$$45 from "./actions/session/deleteSession.ts";
import * as $$$$$$$$$46 from "./actions/session/editSession.ts";
...
import * as $$$47 from "./loaders/recommendations/productList.ts";
import * as $$$48 from "./loaders/recommendations/productListFromCart.ts";
import * as $$$49 from "./loaders/recommendations/productListFromPage.ts";
import * as $$$50 from "./loaders/session/getSession.ts";
import * as $$$51 from "./loaders/session/getUserSessions.ts";
import * as $$$52 from "./loaders/user.ts";
import * as $$$53 from "./loaders/wishlist.ts";
import * as $$$54 from "./loaders/workflow/product.ts";
import * as $$$55 from "./loaders/workflow/products.ts";
...
const manifest = {
  "loaders": {
    ...
    "vtex/loaders/recommendations/productList.ts": $$$47,
    "vtex/loaders/recommendations/productListFromCart.ts": $$$48,
    "vtex/loaders/recommendations/productListFromPage.ts": $$$49,
    "vtex/loaders/session/getSession.ts": $$$50,
    "vtex/loaders/session/getUserSessions.ts": $$$51,
    "vtex/loaders/user.ts": $$$52,
    "vtex/loaders/wishlist.ts": $$$53,
    "vtex/loaders/workflow/product.ts": $$$54,
    "vtex/loaders/workflow/products.ts": $$$55,
  },
  "handlers": {
  ...
  "actions": {
    ...
    "vtex/actions/cart/updateCustomData.ts": $$$$$$$$$22,
    "vtex/actions/cart/updateGifts.ts": $$$$$$$$$23,
    "vtex/actions/cart/updateItemAttachment.ts": $$$$$$$$$24,
    "vtex/actions/cart/updateItemPrice.ts": $$$$$$$$$25,
    "vtex/actions/cart/updateItems.ts": $$$$$$$$$26,
    "vtex/actions/cart/updateProfile.ts": $$$$$$$$$27,
    "vtex/actions/cart/updateUser.ts": $$$$$$$$$28,
    "vtex/actions/credentials/validate.ts": $$$$$$$$$29,
    "vtex/actions/events/productView.ts": $$$$$$$$$30,
    "vtex/actions/events/recommendationClick.ts": $$$$$$$$$31,
    "vtex/actions/events/recommendationView.ts": $$$$$$$$$32,
    "vtex/actions/masterdata/createDocument.ts": $$$$$$$$$33,
    "vtex/actions/masterdata/updateDocument.ts": $$$$$$$$$34,
    "vtex/actions/masterdata/updatePartialDocument.ts": $$$$$$$$$35,
    "vtex/actions/newsletter/subscribe.ts": $$$$$$$$$36,
    "vtex/actions/newsletter/updateNewsletterOptIn.ts": $$$$$$$$$37,
    "vtex/actions/notifyme.ts": $$$$$$$$$38,
    "vtex/actions/orders/cancel.ts": $$$$$$$$$39,
    "vtex/actions/payment/deletePaymentToken.ts": $$$$$$$$$40,
    "vtex/actions/profile/updateProfile.ts": $$$$$$$$$41,
    "vtex/actions/recommendation/startSession.ts": $$$$$$$$$42,
    "vtex/actions/review/submit.ts": $$$$$$$$$43,
    "vtex/actions/session/createSession.ts": $$$$$$$$$44,
    "vtex/actions/session/deleteSession.ts": $$$$$$$$$45,
    "vtex/actions/session/editSession.ts": $$$$$$$$$46,
